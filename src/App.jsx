...
function App() {
    ...
    return (
        <div className="bg-bg-gray min-h-screen w-full relative overflow-x-hidden profile-img">
            ...
            <div className="absolute top-0 left-0 w-full px-6 sm:px-10 md:px-20 z-50 mt-4">
                <Navbar name={name} />
            </div>
